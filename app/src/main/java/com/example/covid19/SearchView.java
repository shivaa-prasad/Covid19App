...
public class SearchView extends ArrayAdapter<CountryModel> {

    private Context context;
    private List<CountryModel> countryModelsList;
    private List<CountryModel> countryModelsListFiltered;

    public SearchView( Context context, List<CountryModel> countryModelsList) {
        super(context, R.layout.list_items,countryModelsList);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_items,null,true);
    ...
    public Filter getFilter() {
        Filter filter = new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                IndividualCountries.countryModelsList = (List<CountryModel>) results.values;
