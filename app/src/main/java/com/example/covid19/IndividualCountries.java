...
public class IndividualCountries extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_individual_countries);
    ...
    private void fetchData() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            searchView = new SearchView(IndividualCountries.this, countryModelsList);
                            LlistView.setAdapter(searchView);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(IndividualCountries.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
